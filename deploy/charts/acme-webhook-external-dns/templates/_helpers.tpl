...
*/}}
{{- define "acme-webhook-external-dns.name" -}}
...
*/}}
{{- define "acme-webhook-external-dns.chart" -}}
...
Common labels
*/}}
{{- define "acme-webhook-external-dns.labels" -}}
app.kubernetes.io/name: {{ include "acme-webhook-external-dns.name" . }}
helm.sh/chart: {{ include "acme-webhook-external-dns.chart" . }}
...
*/}}
{{- define "acme-webhook-external-dns.pdb.spec" -}}
